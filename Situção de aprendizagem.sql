...
select id_midia, ano_lancamento, titulo from midias where ano_lancamento = 1994;
select titulo, genero from midias where tipo = 'Filme' and genero like '%Ficção Cientifica%';
select titulo, tipo, genero from midias where tipo = "Série" and genero = 'Crime, Drama';
select titulo, tipo from midias where titulo like 'O Senhor dos%';
