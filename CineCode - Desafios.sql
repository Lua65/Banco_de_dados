...
select titulo, ano_lancamento from filmes where genero = 'Drama';
...
select nome_cliente, data_conta from clientes order by data_conta limit 10;
...
-- Qual é o erro? Ele tinha colocado estado ao invés de região
-- Correção:
